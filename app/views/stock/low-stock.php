...
<div class="app-container">
    ...
    <main class="main-content">
        <header class="topbar">
            ...
            <div class="topbar-right"><a href="index.php?page=stock&action=adjustment" class="btn btn-primary">Ajustar Estoque</a></div>
        </header>

        <div class="content-area">
            <?php if (empty($lowStockProducts)): ?>
                <div class="alert alert-success">Nenhum produto abaixo do minimo no momento.</div>
            <?php else: ?>
                <div class="card">
